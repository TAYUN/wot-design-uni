...
<template>
  <view>
    ...
    <!-- 瀑布流容器 -->
    <wd-waterfall ref="waterfallRef" :columns="2" :column-gap="10" :row-gap="10" class="waterfall-container" @load-end="loadEnd">
      <wd-waterfall-item v-for="item in items" :key="item.id" :index="item.index" error-handling-mode="fallback" class="waterfall-item">
